...
export const metadata: Metadata = {
  title: "Contact Omnivision Design | Digital Marketing Agency Montreal",
  description:
    "Contact Omnivision Design for a free quote on web design, SEO, Google Ads, and social media marketing services in Montreal. Call (514) 655-6276.",
};
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <address className="not-italic text-white/60 text-sm">
                      106-7470 Sherbrooke St W.<br />
                      Montreal, Quebec Canada H4B 1S5
                    </address>
                  </div>
                </div>
                <div className="flex items-start gap-4">
          ...
          <div className="p-8 bg-white/5 border border-brand-amber/20 rounded-3xl">
            ...
            <form className="space-y-5" aria-label="Contact Form">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    id="firstName"
                    name="firstName"
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-brand-amber transition-colors"
                    placeholder="John"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                >
                  <option value="" className="bg-brand-brown">Select a service</option>
                  <option value="web-design" className="bg-brand-brown">Web Design</option>
                  <option value="seo" className="bg-brand-brown">SEO / GEO</option>
                  <option value="google-ads" className="bg-brand-brown">Google Ads</option>
                  <option value="social-media" className="bg-brand-brown">Social Media</option>
                  <option value="digital-marketing" className="bg-brand-brown">Digital Marketing</option>
                </select>
              </div>
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  rows={5}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-brand-amber transition-colors resize-none"
