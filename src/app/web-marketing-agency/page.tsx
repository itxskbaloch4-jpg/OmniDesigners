...
export const metadata: Metadata = {
  title: "About Omnivision Design | Montreal Web Marketing Agency",
  description:
    "Learn about Omnivision Design, Montreal's top digital marketing agency. Offering web design, SEO, SEM and social media services with 15+ years of experience.",
};
            ...
            {[
              {
                ...
                desc: "Over a decade of proven results helping businesses grow online.",
                icon: "🏆",
              },
              {
                title: "ROI-Focused",
                desc: "Every strategy is designed to deliver measurable return on investment.",
                icon: "📊",
              },
              {
                title: "Bilingual Service",
                desc: "Full service in English and French for Quebec and Canadian businesses.",
                icon: "🌐",
              },
              {
                title: "Specialized SEO",
                desc: "Industry-leading SEO techniques that deliver long-lasting organic results.",
                icon: "🔍",
              },
              {
                title: "Full-Stack Agency",
                desc: "From web design to social media — everything under one roof.",
                icon: "🚀",
              },
              {
              ...
              <div
                key={item.title}
                className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:border-brand-amber/40 transition-all duration-300"
              >
