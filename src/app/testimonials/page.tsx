...
export const metadata: Metadata = {
  title: "Client Testimonials | Omnivision Design Montreal",
  description:
    "Read what Omnivision Design clients say about our web design, SEO, and digital marketing services in Montreal.",
};
...
const testimonials = [
  {
    ...
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/steven-berke-150x150.jpg",
  ...
  },
  {
    ...
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/normand-champigny-150x150.jpg",
  ...
  },
  {
    ...
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/John-Glasspoole-150x150.jpg",
  ...
  },
  {
    ...
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/Elizabeth-Urbanowicz-150x150.jpg",
  ...
  },
  {
    ...
    company: "",
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/Centre-du-Sommeil-150x150.jpg",
  ...
  },
  {
    ...
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/Alexandre-Desjardins-150x150.jpg",
  ...
  },
  {
    ...
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/Laurie-Gordon-150x150.jpg",
    text: "The McKell Institute recently commissioned Omnivision Design to redevelop our website. The transformation has been cost-effective, timely, efficient and the results are absolutely remarkable. I would happily recommend Omnivision to any prospective clients.",
  },
  {
    name: "Carmine Maurizio",
    company: "Manager, Mobility Collection Strategy at Telus",
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/carmine-maurizio-150x150.jpg",
    text: "Omnivision Design produced a fantastic new website for our soccer club and evolved our digital footprint to the top of our industry. Andreas is a professional single point of contact, who constantly works with our organizational constraints to find the solutions best suited for our needs.",
  },
  {
    name: "John Marrett",
    company: "Maximizer CRM Certified Expert",
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/testimonial-1a-150x150.jpg",
    text: "A couple of years ago, I needed a quick website for an event. Andreas and the team at OmniVision got a bilingual website up and running in a couple of weeks, several days before the show!",
  },
  {
    name: "Elie Grinberger",
    company: "HairstyleCITY.com",
    image: "https://www.omnivisiondesign.com/wp-content/uploads/2018/05/testimonial-2a-150x150.jpg",
...
// Hybrid fetch — try API, fallback to static
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((t, i) => (
            <div
              key={i}
              className="p-8 bg-gradient-to-br from-brand-brown/80 to-brand-brown-dark/80 border border-brand-amber/20 rounded-3xl hover:border-brand-amber/50 transition-all duration-300 group flex flex-col"
            >
              <div className="text-brand-amber text-5xl font-display leading-none mb-4 opacity-60">
                &ldquo;
              </div>
              ...
              <div className="flex items-center gap-4 mt-auto">
                ...
                <div>
                  ...
                  {t.company && (
                    <p className="text-brand-amber text-xs">{t.company}</p>
                  )}
                </div>
              </div>
            </div>
