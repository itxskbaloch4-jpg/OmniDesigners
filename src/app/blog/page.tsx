...
export const metadata: Metadata = {
  title: "Digital Marketing Blog | SEO Tips & Insights | Omnivision Design",
  description:
    "Read the latest digital marketing insights, SEO tips, and web design articles from the experts at Omnivision Design Montreal.",
};
