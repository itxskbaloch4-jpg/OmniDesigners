      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-4">
              Omnivision Design is a Montreal Web Marketing Company, offering internet marketing
              services to small, medium and large businesses including public companies, and has the
              best quality web marketing strategy for companies in any industry.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              {latestPosts.map((post) => (
                <li key={post.href}>
                  <Link
                    href={post.href}
                    className="text-sm text-white/70 hover:text-brand-amber transition-colors leading-snug block"
                  >
                    {post.title}
                  </Link>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            {[
              ...
              <a
                ...
                aria-label={label}
                className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white/70 hover:text-brand-amber hover:border-brand-amber hover:bg-brand-amber/10 transition-all duration-300"
              >
          ...
          <p className="text-sm text-white/40">
            © {new Date().getFullYear()} Omnivision Design. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
