    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="flex flex-col md:flex-row items-start md:items-center justify-between mb-16 gap-4"
        >
          <div>
          ...
          <Link
            href="/blog/"
            className="flex items-center gap-2 text-brand-amber font-semibold hover:gap-3 transition-all duration-300"
          >
            View All Posts
          ...
          {posts.map((post, i) => (
            ...
            >
              <Link href={post.href} className="group block">
                ...
                <h3 className="font-bold text-white text-lg leading-snug group-hover:text-brand-amber transition-colors duration-300 mb-4">
                  {post.title}
                </h3>
