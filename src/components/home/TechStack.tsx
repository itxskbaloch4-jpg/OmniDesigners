...
export default function TechStack() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-24 bg-brand-brown-dark overflow-hidden"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/60 text-base max-w-xl mx-auto">
            We use industry-leading platforms and tools to deliver exceptional digital experiences.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {technologies.map((tech, i) => (
            <motion.div
              ...
              className="group flex flex-col items-center gap-2 p-4 bg-white/5 border border-white/10 rounded-xl hover:border-brand-amber/50 hover:bg-white/10 transition-all duration-300"
            >
              ...
              <span className="text-brand-amber/60 text-[10px] uppercase tracking-wider">
                {tech.category}
              </span>
            </motion.div>
          ))}
