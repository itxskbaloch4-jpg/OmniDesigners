...
const steps = [
  {
    number: "01",
    title: "Get In Touch",
    description: "Contact us and let us know about your goals, current challenges, and vision.",
    href: "/contact/",
    cta: "Learn more",
  },
  {
    ...
    description: "Our team designs and develops a high-performance, SEO-optimized website tailored for you.",
    href: "/web-design/",
    cta: "Learn more",
  },
  {
    ...
    description: "We execute a comprehensive digital marketing strategy to drive traffic and conversions.",
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="relative inline-flex items-center justify-center mb-8">
                  <motion.div
                    ...
                    className="w-32 h-32 rounded-full bg-gradient-to-br from-brand-amber to-brand-amber-dark flex items-center justify-center shadow-2xl amber-glow"
                  >
                    <span className="font-display text-4xl font-bold text-brand-brown">
                      {step.number}
                    </span>
                  </motion.div>
                  {/* Ripple effect */}
                ...
                <h3 className="font-display text-2xl font-bold text-white mb-4 group-hover:text-brand-amber transition-colors">
                  {step.title}
                </h3>
                ...
                <Link
                  href={step.href}
                  className="inline-flex items-center gap-1 text-brand-amber font-semibold text-sm hover:underline"
                >
                  {step.cta}
                </Link>
              </motion.div>
        ...
        <motion.div
          ...
          className="mt-20 relative p-10 bg-gradient-to-br from-brand-amber/10 to-brand-brown-dark/50 border border-brand-amber/30 rounded-3xl text-center overflow-hidden"
        >
          ...
          <p className="text-white/60 mb-6 text-base">
            Calculate the price of your dream website. We&apos;re excited to bring your vision to life!
          </p>
          <Link
