...
export default function TestimonialsSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-32 bg-brand-brown-dark overflow-hidden"
    ...
    >
        ...
        >
          ...
          >
            {testimonials.map((t, i) => (
              <SwiperSlide key={i}>
                <div className="h-full p-8 bg-gradient-to-br from-brand-brown/80 to-brand-brown-dark/80 border border-brand-amber/20 rounded-3xl backdrop-blur-sm hover:border-brand-amber/50 transition-all duration-300 group">
                  {/* Quote mark */}
                  <div className="text-brand-amber text-6xl font-display leading-none mb-4 opacity-60">
                    &ldquo;
                  </div>
      ...
      <style jsx global>{`
        .swiper-pagination-bullet {
          background: rgba(255, 166, 2, 0.4) !important;
          opacity: 1 !important;
        }
